...
if(mysqli_query($con,"INSERT INTO $table($fields) VALUES ($datas)"))
{
	$iid=mysqli_insert_id($con);
	   $dob=$_POST['dob'];
    $age = (date('Y') - date('Y',strtotime($dob)));
	mysqli_query($con,"UPDATE $table SET age='$age' WHERE id='$iid'");
	
	//echo "UPDATE $table SET age='$age' WHERE id='$iid'";
