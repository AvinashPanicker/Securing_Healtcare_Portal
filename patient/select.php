...
<table id="example" class="table table-striped table-bordered dataTable no-footer clearfix" cellspacing="0"  role="grid" aria-describedby="example_info"  width="100%">
   ...
   echo "<tbody>";
 	...
 	$result = mysqli_query($con,"SELECT * FROM $table ");
		...
		for($k=0;$k<$i;$k++)
		{
			...
			<a href='http://cloudviews.in/SMS/gateway.php?email=$row[email]&msg=Your User Id $row[patient_regno] and Password for login $row[password]' target='_blank'>Send Passsord</a>
