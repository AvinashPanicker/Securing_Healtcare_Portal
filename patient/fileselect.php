 ...
 <th>Del</th> 
  ...
  // $i=0;
   echo "<tbody>";
 	...
 	$result = mysqli_query($con,"SELECT * FROM $table where patient_id='$_REQUEST[pid]' ");
...
if($_SESSION['user']=="admin")
	echo "<td > <a href='../document/decrypted/$row[$k]' target='_blank'> $row[$k] </a> </td>";
			...
			echo "<td > <a href='orgview.php?data=$row[$k]' target='_blank'> $row[$k] </a> </td>";
...
</script><script src="../assets/js/jquery-1.10.2.js" type="text/javascript"></script>
